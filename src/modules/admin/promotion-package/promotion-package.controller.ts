...
export async function listHandler(_req: Request, res: Response) {
  try {
    return res.json({ success: true, packages: service.listPromotionPackages() });
  } catch (error: any) {
...
export async function createHandler(req: Request, res: Response) {
  try {
    ...
    const item = service.createPromotionPackage(body);
...
export async function patchHandler(req: Request, res: Response) {
  try {
    ...
    const item = service.updatePromotionPackage(id, req.body ?? {});
...
export async function deleteHandler(req: Request, res: Response) {
  try {
    const id = req.params.id;
    const deleted = service.deletePromotionPackage(id);
